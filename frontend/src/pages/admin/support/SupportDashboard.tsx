...
const SupportDashboard: React.FC = () => {
  ...
  const supportSections = [
    {
      title: 'Usuarios',
      description: 'Ver y gestionar información de usuarios',
    ...
    <AdminLayout title="Soporte">
      ...
      <div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Información del Rol de Soporte</h2>
            ...
            <div>
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                ...
                <li className="flex items-center">
                  ...
                  Exportación CSV requiere IP autorizada
                </li>
              </ul>
            </div>
          </div>
