        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-secondary-600 mb-8 leading-relaxed max-w-2xl">
              ...
              <strong className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">12.5% de rendimiento diario</strong> durante 8 días de operación por ciclo.
