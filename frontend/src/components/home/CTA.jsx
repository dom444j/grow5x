        ...
        <div className="text-center">
          ...
          <div className="bg-gradient-to-r from-yellow-500/25 to-orange-500/25 border-2 border-yellow-400/50 rounded-2xl p-8 max-w-3xl mx-auto mb-12 backdrop-blur-md shadow-2xl animate-pulse">
            ...
            <p className="text-yellow-100 text-lg leading-relaxed">
              Los primeros <span className="font-bold text-yellow-300">1000 usuarios</span> registrados este mes 
              <span className="font-bold text-orange-300">reciben bonos extra</span> en su primer ciclo de agentes IA. 
              <br />
